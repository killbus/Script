...
[task_local]
#腾讯自选股
 https://raw.githubusercontent.com/leafxcy/JavaScript/main/txstockV2.js, tag=腾讯自选股, enabled=true
[rewrite_local]
...
let newbieFlag = ($.isNode() ? (process.env.TxStockNewbie) : ($.getval('TxStockNewbie'))) || 1; //0为不做新手任务，1为自动做新手任务
